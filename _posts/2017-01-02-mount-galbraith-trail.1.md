...
**Total Moving Time:** 1 hour 45 minutes  
**Average Speed:** 2.3 mph (Icy)  

{% include image.html path="week1/trail_topo.png" path-detail="week1/trail_topo.png" alt="Mount Galbraith Topo" %} {% include image.html path="week1/trail_profile.png" path-detail="week1/trail_profile.png" alt="Mount Galbraith Profile" %} {% include image.html path="week1/trail_topo_square.png" path-detail="week1/trail_topo_square.png" alt="Mount Galbraith Profile" %}
